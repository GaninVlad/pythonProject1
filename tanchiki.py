...
pygame.mixer.music.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/sounds/tanchiki_fon_music.mp3')
pygame.mixer.music.set_volume(0.1)
sound_shoot = pygame.mixer.Sound(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/sounds/tanchiki_vistrel.wav')
sound_shoot.set_volume(0.5)
sound_uncht_tanka = pygame.mixer.Sound(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/sounds/tanchili_vzriv_tanka.wav')
sound_uncht_tanka.set_volume(0.6)
sound_hit_on_tank = pygame.mixer.Sound(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/sounds/tanchiki_hit_on_tank.wav')
sound_hit_on_tank.set_volume(0.2)
sound_medkit = pygame.mixer.Sound(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/sounds/tanchiki_medkit.wav')
sound_medkit.set_volume(0.5)
sound_boost = pygame.mixer.Sound(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/sounds/tanchiki_boost.wav')
sound_boost.set_volume(0.15)

# connect db
conn = sqlite3.connect(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/tanchiki_database.sql')
cur = conn.cursor()
...
pygame.display.set_icon(pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/icon_tanchiki.ico'))
bg = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/bg_tanki.png').convert()
bg_pause = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/bg_pause_game_tanki.png').convert()
bg_wait_for_players = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/wait_for_players.png').convert_alpha()
boost_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/boost.png').convert_alpha()
boost_img_or = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/boost_or.png').convert_alpha()
medkit_img_or = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/medkit_or.png').convert_alpha()
bullet_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/bullet_tank.png').convert_alpha()
effects_img = [pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/effect_shield.png').convert_alpha(),
               pygame.image.load(
                   '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/effect_slow.png').convert_alpha(),
               pygame.image.load(
                   '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/effect_teleport.png').convert_alpha(),
               pygame.image.load(
                   '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/effect_speed.png').convert_alpha(),
               pygame.image.load(
                   '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/effect_-1hp.png').convert_alpha(),
               pygame.image.load(
                   '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/effect_+1att.png').convert_alpha()
               ]
main_disp_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/main_disp.png').convert_alpha()
medkit_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/medkit.png').convert_alpha()
nastr_spravka_bg_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/nastroiki_spravka.png').convert_alpha()
spravka_off_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/spravka.png').convert_alpha()
spravka_onl_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/spravka_online.png').convert_alpha()
tank_img, tank1_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/tank.png').convert_alpha(), \
    pygame.image.load(
        '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/tank1.png').convert_alpha()
tank_razr_img, tank1_razr_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/tank1_razr.png').convert_alpha(),\
    pygame.image.load(
        '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/tank2_razr.png').convert_alpha()
wall_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/wall_tank.png').convert_alpha()
zvuk_on_img, zvuk_off_img = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/zvuk_tanchiki_on.png').convert_alpha(),\
    pygame.image.load(
        '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/zvuk_tanchiki_off.png').convert_alpha()
tank1_hp = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/tank1_hp.png').convert_alpha()
tank2_hp = pygame.image.load(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/images/tanchiki/tank2_hp.png').convert_alpha()

# upload fonts
font_schet = pygame.font.Font(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/Fonts/Intro.ttf', 15)
font_st_disp_errors = pygame.font.Font(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/Fonts/PsychicForce2012Monospaced.ttf', 20)
font_st_disp = pygame.font.Font(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/Fonts/PsychicForce2012Monospaced.ttf', 40)
font_sprav_main_nastr = pygame.font.Font(
    '../../Downloads/PROJECT_Pygame_Tanchiki-master (1)/PROJECT_Pygame_Tanchiki-master/Fonts/PsychicForce2012Monospaced.ttf', 120)
